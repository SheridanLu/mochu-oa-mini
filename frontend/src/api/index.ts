...
export const api = {
  ...
  statement: {
    ...
    update: (data: any) => request({ url: '/api/statement', method: 'PUT', data }),
    ...
    generateManual: (data: any) => request({ url: '/api/statement/generate-manual', method: 'POST', data }),
    ...
    saveDifferenceRemark: (data: any) => request({ url: '/api/statement/difference/remark', method: 'POST', data }),
    exportDifference: (data: any) => request({ url: '/api/statement/difference/export', method: 'POST', data }),
    createSplit: (data: any) => request({ url: '/api/statement/split', method: 'POST', data }),
  ...
  paymentSupervision: {
    ...
    update: (data: any) => request({ url: '/api/payment-supervision', method: 'PUT', data }),
