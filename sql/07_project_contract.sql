...
CREATE TABLE biz_project (
    ...
    project_alias       VARCHAR(100) COMMENT '项目别名',
    ...
    amount_without_tax  DECIMAL(18,2) DEFAULT 0 COMMENT '不含税金额',
    ...
    budget_limit        DECIMAL(18,2) COMMENT '拟投入项目金额限额',
    bid_date            DATE COMMENT '预计投标时间',
    winning_notice      VARCHAR(500) COMMENT '中标通知书',
    winning_amount      DECIMAL(18,2) COMMENT '中标金额',
    attachment_paths    TEXT COMMENT '附件路径',
